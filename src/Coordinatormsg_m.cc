...
void Coordinatormsg_Base::copy(const Coordinatormsg_Base& other)
{
    ...
    this->ST_Node = other.ST_Node;
    this->ST_Time = other.ST_Time;
}
...
void Coordinatormsg_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->ST_Node);
    doParsimPacking(b,this->ST_Time);
}
...
void Coordinatormsg_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->ST_Node);
    doParsimUnpacking(b,this->ST_Time);
}
...
int Coordinatormsg_Base::getST_Node() const
{
    return this->ST_Node;
}

void Coordinatormsg_Base::setST_Node(int ST_Node)
{
    this->ST_Node = ST_Node;
}

int Coordinatormsg_Base::getST_Time() const
{
    return this->ST_Time;
}

void Coordinatormsg_Base::setST_Time(int ST_Time)
{
...
int CoordinatormsgDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='M' && strcmp(fieldName, "MType")==0) return base+0;
    if (fieldName[0]=='S' && strcmp(fieldName, "ST_Node")==0) return base+1;
    if (fieldName[0]=='S' && strcmp(fieldName, "ST_Time")==0) return base+2;
...
int CoordinatormsgDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    Coordinatormsg_Base *pp = (Coordinatormsg_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *CoordinatormsgDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string CoordinatormsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    Coordinatormsg_Base *pp = (Coordinatormsg_Base *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getMType());
        case 1: return long2string(pp->getST_Node());
        case 2: return long2string(pp->getST_Time());
        default: return "";
    }
}

bool CoordinatormsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    Coordinatormsg_Base *pp = (Coordinatormsg_Base *)object; (void)pp;
    switch (field) {
        case 0: pp->setMType((value)); return true;
        case 1: pp->setST_Node(string2long(value)); return true;
        case 2: pp->setST_Time(string2long(value)); return true;
...
void *CoordinatormsgDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
